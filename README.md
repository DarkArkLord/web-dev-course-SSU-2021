...
- Интеллект - отвечает за {~ ~ ДаНнЫе ЗаШиФрОвАнЫ ~ ~};
...
Каждая Программа имеет при себе оружие, Базовая Сила которого равна `(<Уровень Силы> + <Модификатор успеха>) * (<Уровень оружия> + 1)`. Наносимый урон расчитывается по формуле `{~ ~ ДаНнЫе ЗаШиФрОвАнЫ ~ ~}`. По умолчанию у Программы первого уровня оружие имеет 0 уровень. У Тестовой Антивирусной Программы оружие изначально имеет 1 уровень.
